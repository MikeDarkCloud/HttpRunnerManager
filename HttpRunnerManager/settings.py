...
if DEBUG:
    DATABASES = {
        'default': {
            ...
            'USER': 'yzDev',  # 数据库登录名
            'PASSWORD': '@yZdev0512!',  # 数据库登录密码
            'HOST': '120.24.167.89',  # 数据库所在服务器ip地址
...
EMAIL_SEND_USERNAME = 'lanmingyong@126.com'  # 定时任务报告发送邮箱，支持163,qq,sina,企业qq邮箱等，注意需要开通smtp服务
EMAIL_SEND_PASSWORD = 'mike5788973'     # 邮箱密码
